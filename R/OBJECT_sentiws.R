...
#'   \item{word}{Chr. Name of the word}
#'   \item{value}{Num. Sentiment value}
#'   \item{inflections}{Chr. Inflections}
#' }
#' @source R. Remus, U. Quasthoff & G. Heyer: SentiWS - a Publicly Available German-language Resource for Sentiment Analysis. In: Proceedings of the 7th International Language Ressources and Evaluation (LREC'10), pp. 1168-1171, 2010, see \url{http://wortschatz.uni-leipzig.de/en/download/}
